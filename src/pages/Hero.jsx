...
const Hero = () => {
    return (
        <div className="fixed top-0 right-0 z-10 bg-transparent text-white p-8 mt-[125px] md:w-[700px]">
            <div>
                <div className="flex items-center ">
                    <div className="text-white ml-8 sm:text-right text-center">
                        <div className="mb-2">
                            <h1 className="font-black md:text-[80px] sm:text-[60px] xs:text-[50px] text-[45px] sm:leading-[90px] leading-[60px] mt-2 mb-2">
